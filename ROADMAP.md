...
- [x] `S` Versionado semántico, `CHANGELOG.md` y release automatizada en CI al taggear. `CHANGELOG.md` añadido (Keep a Changelog), `gradle.properties` en `1.0.0`, y el workflow de CI publica un GitHub Release con el jar adjunto al pushear un tag `v*` — tag `v1.0.0` creado y pusheado a petición del mantenedor.
