...
CREATE INDEX idx_br_reports_target   ON br_reports(target_uuid);
CREATE INDEX idx_br_reports_status   ON br_reports(status);
CREATE INDEX idx_br_reports_reporter ON br_reports(reporter_uuid, created_at);
...
CREATE INDEX idx_br_penalties_player ON br_report_penalties(player_uuid);
